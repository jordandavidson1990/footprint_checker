  ...
  try{throw this.currentCategory}
    ...
    PubSub.subscribe('CategoryView:submit-next-category', (event) => {
      ...
      const categoryDiv =
       ...
       categoryView.render(topic.questions, questionsCollection.findIndex(c => c.category === topic.category)+1, topic.category, topic.questions.length, questionsCollection.length, topic.fact, topic.image)
       // debugger
