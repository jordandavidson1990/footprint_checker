...
//   this.container.innerHTML = '';
  ...
  PubSub.subscribe('CarbonFootprints:results-ready', (totalCarbonFootPrints) => {
    ...
    if(8000 > totalCarbonFootPrints.detail && totalCarbonFootPrints.detail <= 10000){
    ...
    if(totalCarbonFootPrints.detail < 8000){
      const low = document.createElement('h5');
      low.textContent = `Well done!! ${totalCarbonFootPrints.detail} is below average. Keep up the good work!`
